...
class EmployeeSystem:
    ...
    #--------------------------Frame2------------------------------------
        ...
        btn_delete = Button(Frame2,text="Delete",command=self.add,
        font=("times new roman",20)
...
#====================All functions Start here===========================
        ...
        if self.var_code.get()=='' or self.var_salary.get()=='' or self.var_name=='':
            ...
            try:
                ...
                if rows != None:
                    ...
                    con.commit()
                    con.close()
                    file_=open('salary_recipt/'+str(self.var_code.get()),'w')
    ...
    def calculate(self):
            if self.var_month.get()=='' or self.var_year.get()=='' or self.var_salary()=='' or self.var_totaldays()=='' or self.var_absent()=='' or self.var_Medical()=='' or self.var_pf()=='' or self.var_convence()=='' or self.var_net_salary()=='':
