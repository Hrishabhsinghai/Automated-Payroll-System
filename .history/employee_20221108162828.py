...
class EmployeeSystem:
    ...
    #=======================calculator frame=============================
        ...
        Cal_Frame.place(x=2,y=2,width=280,height=300)
        ...
        btn_7=Button(Cal_Frame,text='7',font=("italic",15,"bold")).place(x=61,y=42,w=60,h=60)
        btn_7=Button(Cal_Frame,text='7',font=("italic",15,"bold")).place(x=122,y=42,w=60,h=60)
        btn_7=Button(Cal_Frame,text='7',font=("italic",15,"bold")).place(x=183,y=42,w=60,h=60)
