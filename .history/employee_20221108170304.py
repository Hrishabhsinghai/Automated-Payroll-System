...
class EmployeeSystem:
    ...
    #=======================calculator frame=============================
        ...
        btn_dot=Button(Cal_Frame,text='.',command=lambda:btn_click('.'),font=("italic",15,"bold")).place(x=61,y=232,w=60,h=60)
        btn_add=Button(Cal_Frame,text='+',command=lambda:btn_click('+'),font=("italic",15,"bold")).place(x=122,y=232,w=60,h=60)
        btn_equal=Button(Cal_Frame,text='=',command=lambda:btn_click('='),font=("italic",15,"bold")).place(x=183,y=232,w=60,h=60)
