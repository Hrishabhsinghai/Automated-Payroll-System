...
#-----------------------------------------------------------------------------
        ...
        font=("times new roman",20)
        ,bg="white",fg="black").place(x=150,y=240,height=30,width=120)

        btn_add = Button(Frame2,text="Add",
        font=("times new roman",20)
        ,bg="white",fg="black").place(x=285,y=240,height=30,width=120)

        btn_clear = Button(Frame2,text="clear",
        font=("times new roman",20)
        ,bg="white",fg="black").place(x=420,y=240,height=30,width=120)
    #--------------------------Frame3------------------------------------
