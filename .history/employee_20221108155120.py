...
class EmployeeSystem:
    ...
    #--------------------------Frame2------------------------------------
        ...
        font=("times new roman",15)
        ,bg="lightyellow",fg="black").place(x=133,y=120,width=100)
        ...
        font=("times new roman",15)
        ,bg="lightyellow",fg="black").place(x=395,y=120,width=100)
        ...
        font=("times new roman",15)
        ,bg="lightyellow",fg="black").place(x=133,y=150, width=100)
        ...
        font=("times new roman",15)
        ,bg="lightyellow",fg="black").place(x=395,y=150,width=100)
#------------------------------------------------------------------
        ...
        font=("times new roman",15)
        ,bg="lightyellow",fg="black").place(x=133,y=180, width=100)
        ...
        font=("times new roman",15)
        ,bg="lightyellow",fg="black").place(x=395,y=180,width=100)
