...
class EmployeeSystem:
    ...
    #=======================calculator frame=============================
        ...
        btn_7=Button(Cal_Frame,text='7',font=("italic",15,"bold")).place(x=51,y=42,w=60,h=60)
        btn_7=Button(Cal_Frame,text='7',font=("italic",15,"bold")).place(x=102,y=42,w=60,h=60)
        btn_7=Button(Cal_Frame,text='7',font=("italic",15,"bold")).place(x=153,y=42,w=60,h=60)
