...
class EmployeeSystem:
    ...
    #=======================calculator frame=============================
        ...
        btn_7=Button(Cal_Frame,text='4',font=("italic",15,"bold")).place(x=244,y=82,w=60,h=60)
        btn_7=Button(Cal_Frame,text='5',font=("italic",15,"bold")).place(x=305,y=82,w=60,h=60)
        btn_7=Button(Cal_Frame,text='6',font=("italic",15,"bold")).place(x=366,y=82,w=60,h=60)
        btn_7=Button(Cal_Frame,text='*',font=("italic",15,"bold")).place(x=427,y=82,w=60,h=60)
