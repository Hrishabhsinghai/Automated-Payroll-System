...
class EmployeeSystem:
    ...
    #=======================calculator frame=============================
        ...
        txt_Result=Entry(Cal_Frame,bg="lightyellow", font=("times new roman",20,"bold"),justify=RIGHT)
        txt_Result.place(x=0,y=0,relwidth=1,height=50)

        btn_7=Button(Cal_Frame,text='7',font=("italic",15,"bold")).place(x=0,y=52,w=60,h=60)
        btn_8=Button(Cal_Frame,text='8',font=("italic",15,"bold")).place(x=61,y=52,w=60,h=60)
        btn_9=Button(Cal_Frame,text='9',font=("italic",15,"bold")).place(x=122,y=52,w=60,h=60)
        btn_div=Button(Cal_Frame,text='/',font=("italic",15,"bold")).place(x=183,y=52,w=60,h=60)

        btn_4=Button(Cal_Frame,text='4',font=("italic",15,"bold")).place(x=0,y=112,w=60,h=60)
        btn_5=Button(Cal_Frame,text='5',font=("italic",15,"bold")).place(x=61,y=112,w=60,h=60)
        btn_6=Button(Cal_Frame,text='6',font=("italic",15,"bold")).place(x=122,y=112,w=60,h=60)
        btn_mul=Button(Cal_Frame,text='*',font=("italic",15,"bold")).place(x=183,y=112,w=60,h=60)

        btn_1=Button(Cal_Frame,text='1',font=("italic",15,"bold")).place(x=0,y=172,w=60,h=60)
        btn_2=Button(Cal_Frame,text='2',font=("italic",15,"bold")).place(x=61,y=172,w=60,h=60)
        btn_3=Button(Cal_Frame,text='3',font=("italic",15,"bold")).place(x=122,y=172,w=60,h=60)
        btn_sub=Button(Cal_Frame,text='-',font=("italic",15,"bold")).place(x=183,y=172,w=60,h=60)

        btn_0=Button(Cal_Frame,text='0',font=("italic",15,"bold")).place(x=0,y=232,w=60,h=60)
        btn_dot=Button(Cal_Frame,text='.',font=("italic",15,"bold")).place(x=61,y=232,w=60,h=60)
        btn_add=Button(Cal_Frame,text='+',font=("italic",15,"bold")).place(x=122,y=232,w=60,h=60)
        btn_equal=Button(Cal_Frame,text='=',font=("italic",15,"bold")).place(x=183,y=232,w=60,h=60)
