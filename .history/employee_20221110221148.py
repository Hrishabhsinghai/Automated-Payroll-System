...
#====================All functions Start here===========================
    ...
    def add(self):
        ...
        def calculate(self):
            if self.var_month.get()=='' or self.var_year.get()=='' or self.var_salary()=='' or self.var_totaldays()=='' or self.var_Absents()=='' or self.var_Medical()=='' or self.var_pf()=='' or self.var_convence()=='' or self.var_netsalary()=='':
