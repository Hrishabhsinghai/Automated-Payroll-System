...
class EmployeeSystem:
    ...
    #--------------------------Frame2------------------------------------
        ...
        lbl_designation = Label(Frame2,text="Designation",
        font=("times new roman",18)
        ,bg="white",fg="black").place(x=10,y=120)

        text_designation = Entry(Frame2,
        font=("times new roman",15)
        ,bg="lightyellow",fg="black").place(x=133,y=120,width=100)

        lbl_DOB = Label(Frame2,text="D.O.B",
        font=("times new roman",18)
        ,bg="white",fg="black").place(x=300,y=120,)

        text_DOB = Entry(Frame2,
        font=("times new roman",15)
        ,bg="lightyellow",fg="black").place(x=400,y=122,width=100)
