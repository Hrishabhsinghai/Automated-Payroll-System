...
class EmployeeSystem:
    ...
    #=======================calculator frame=============================
        ...
        btn_7=Button(Cal_Frame,text='7',font=("italic",15,"bold")).place(x=0,y=42,w=60,h=60)
        btn_7=Button(Cal_Frame,text='8',font=("italic",15,"bold")).place(x=61,y=42,w=60,h=60)
        btn_7=Button(Cal_Frame,text='9',font=("italic",15,"bold")).place(x=122,y=42,w=60,h=60)
        btn_7=Button(Cal_Frame,text='/',font=("italic",15,"bold")).place(x=183,y=42,w=60,h=60)

        btn_7=Button(Cal_Frame,text='4',font=("italic",15,"bold")).place(x=0,y=102,w=60,h=60)
        btn_7=Button(Cal_Frame,text='5',font=("italic",15,"bold")).place(x=61,y=102,w=60,h=60)
        btn_7=Button(Cal_Frame,text='6',font=("italic",15,"bold")).place(x=122,y=102,w=60,h=60)
        btn_7=Button(Cal_Frame,text='*',font=("italic",15,"bold")).place(x=183,y=102,w=60,h=60)

        btn_7=Button(Cal_Frame,text='1',font=("italic",15,"bold")).place(x=0,y=162,w=60,h=60)
        btn_7=Button(Cal_Frame,text='2',font=("italic",15,"bold")).place(x=61,y=162,w=60,h=60)
        btn_7=Button(Cal_Frame,text='3',font=("italic",15,"bold")).place(x=122,y=162,w=60,h=60)
        btn_7=Button(Cal_Frame,text='-',font=("italic",15,"bold")).place(x=183,y=162,w=60,h=60)

        btn_7=Button(Cal_Frame,text='0',font=("italic",15,"bold")).place(x=0,y=222,w=60,h=60)
        btn_7=Button(Cal_Frame,text='.',font=("italic",15,"bold")).place(x=61,y=222,w=60,h=60)
        btn_7=Button(Cal_Frame,text='+',font=("italic",15,"bold")).place(x=122,y=222,w=60,h=60)
        btn_7=Button(Cal_Frame,text='=',font=("italic",15,"bold")).place(x=183,y=222,w=60,h=60)
