...
'''
    ...
    def employee_frame(self):
          ...
          self.employee_tree = ttk.Treeview(self.root2,columns=('e_id', 'designation', 'name', 'age', 'gender', 'email', 'hired', 'doj', 'dob', 'experience', 'proof', 'contact', 'status', 'address', 'month', 'year', 'salary', 'totaldays', 'absent', 'medical', 'pf', 'convence', 'net_salary', 'salary_recipt'))
