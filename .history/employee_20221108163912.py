...
class EmployeeSystem:
    ...
    #=======================calculator frame=============================
        ...
        Cal_Frame.place(x=2,y=2,width=247,height=310)
        ...
        btn_7=Button(Cal_Frame,text='8',font=("italic",15,"bold")).place(x=61,y=52,w=60,h=60)
        btn_7=Button(Cal_Frame,text='9',font=("italic",15,"bold")).place(x=122,y=52,w=60,h=60)
        btn_7=Button(Cal_Frame,text='/',font=("italic",15,"bold")).place(x=183,y=52,w=60,h=60)

        btn_7=Button(Cal_Frame,text='4',font=("italic",15,"bold")).place(x=0,y=112,w=60,h=60)
        btn_7=Button(Cal_Frame,text='5',font=("italic",15,"bold")).place(x=61,y=112,w=60,h=60)
        btn_7=Button(Cal_Frame,text='6',font=("italic",15,"bold")).place(x=122,y=112,w=60,h=60)
        btn_7=Button(Cal_Frame,text='*',font=("italic",15,"bold")).place(x=183,y=112,w=60,h=60)

        btn_7=Button(Cal_Frame,text='1',font=("italic",15,"bold")).place(x=0,y=172,w=60,h=60)
        btn_7=Button(Cal_Frame,text='2',font=("italic",15,"bold")).place(x=61,y=172,w=60,h=60)
        btn_7=Button(Cal_Frame,text='3',font=("italic",15,"bold")).place(x=122,y=172,w=60,h=60)
        btn_7=Button(Cal_Frame,text='-',font=("italic",15,"bold")).place(x=183,y=172,w=60,h=60)

        btn_7=Button(Cal_Frame,text='0',font=("italic",15,"bold")).place(x=0,y=232,w=60,h=60)
        btn_7=Button(Cal_Frame,text='.',font=("italic",15,"bold")).place(x=61,y=232,w=60,h=60)
        btn_7=Button(Cal_Frame,text='+',font=("italic",15,"bold")).place(x=122,y=232,w=60,h=60)
        btn_7=Button(Cal_Frame,text='=',font=("italic",15,"bold")).place(x=183,y=232,w=60,h=60)
